...
public class HomeFrame extends JFrame {
	...
	private void init() {
		...
		btnCreaterQuestions.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(0,238, 224), 0));
		btnCreaterQuestions.setRolloverEnabled(false);
		panelbt.add(btnCreaterQuestions);
		
		panelbt.setBackground(new Color(0, 238, 224));
		btnUpdateQuestions = new JButton("Alterar Questões");
		...
		btnUpdateQuestions.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(0, 238, 224), 0));
		...
		btnReadQuestions.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(0,238, 224), 0));
		btnReadQuestions.setRolloverEnabled(false);
		panelbt.add(btnReadQuestions);
		
		add(panelbt, BorderLayout.CENTER);
		btnAnswerQuestions = new JButton("Responder Questões");
		...
		btnAnswerQuestions.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(0,238, 224), 0));
		btnAnswerQuestions.setRolloverEnabled(false);
		panelbt.add(btnAnswerQuestions);
		add(panelbt, BorderLayout.CENTER);
		
		add(panelbt, BorderLayout.CENTER);
		btnDeleteQuestions = new JButton("Deletar Questões");
		...
		btnDeleteQuestions.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(0,238, 224), 0));
